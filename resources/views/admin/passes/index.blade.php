<x-app-layout>
    ...
    <style>
        ...
        .dark-box { background-color: #09090b; border: 1px solid rgba(147, 51, 234, 0.4); box-shadow: 0 0 20px rgba(147, 51, 234, 0.15); border-radius: 1rem; padding: 1.5rem; color: #e5e7eb; margin-bottom: 2rem; position: relative; }
        ...
        .input-dark { width: 100%; background-color: #000 !important; border: 1px solid #4c1d95 !important; color: #fff !important; border-radius: 0.5rem !important; padding: 0.5rem; margin-top: 0.25rem; }
        .input-dark:focus { border-color: #db2777 !important; outline: none; box-shadow: 0 0 10px rgba(219, 39, 119, 0.3); }
        
        .btn-submit { background: linear-gradient(90deg, #6d28d9, #db2777); color: white; font-weight: bold; padding: 8px 16px; border-radius: 0.5rem; border: none; cursor: pointer; transition: 0.3s; width: 100%; text-transform: uppercase; letter-spacing: 1px; }
        .btn-submit:hover { box-shadow: 0 0 15px rgba(219, 39, 119, 0.6); transform: scale(1.02); }

        .table-dark { width: 100%; text-align: left; border-collapse: collapse; margin-top: 1rem; }
        .table-dark th { border-bottom: 2px solid #4c1d95; padding: 8px; color: #a855f7; font-weight: bold; text-transform: uppercase; font-size: 0.8rem; }
        .table-dark td { border-bottom: 1px solid #1f2937; padding: 8px; font-size: 0.9rem; }
        .table-dark tr:hover { background-color: rgba(147, 51, 234, 0.1); }
    </style>
